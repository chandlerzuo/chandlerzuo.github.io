...
A more disturbing example is the median household income. We hope to see no correlation between income levels and COVID death rates, assuming that in an ideal world medical resources are deployed to all regions regardless of their economic status. Data, however, show negative correlation between the two, and the pattern even seems to be stronger than the correlation with the proportion of aged population. Comparing counties with median household income below 50K with those above 100K, death rates are mostly above 3% for the former counties and below 3% for the latter. 
